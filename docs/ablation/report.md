...
- **Protocol Version**: `playground-feature-ablation-v1` (SHA-256: `41c0ce06d5fa6f07...`)
...
| **S1** (`kcp-mobility-27-v1`) | 27 | 0.8921 ± 0.0108 | [-0.3064, -0.1784] | 0.2314 ± 0.0025 | 0.0500 ± 0.0099 | +21.51% | FAILED |
| **S2** (`kcp-mobility-pawns-31-v1`) | 31 | 0.7991 ± 0.1042 | [-0.4260, -0.2528] | 0.2308 ± 0.0020 | 0.0568 ± 0.0066 | +29.69% | FAILED |
...
|---|---|---|---|
| `relative_log_loss_gain_gte_1pct` | **PASS** | **PASS** | >= +1.0% relative gain |
| `paired_ci_upper_lt_0` | **FAIL** | **FAIL** | Paired 95% CI upper bound < 0 across seeds (p < 0.05) |
